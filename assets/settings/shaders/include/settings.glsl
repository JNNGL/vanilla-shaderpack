...
#define SUN_PATH_ROTATION_Y -10.0
...
#define RAYLEIGH_DENSITY_PROFILE vec4(1.0, 0.8 / 8.0e3, 0.0, 0.0)

#define MIE_SCATTERING_BETA 0.8e-5
#define MIE_DENSITY_PROFILE vec4(1.0, 1.0 / 1.2e3, 0.0, 0.0)
#define MIE_ABSORPTION_BASE 4.4e-6
...
#define EARTH_ALBEDO vec3(0.0)

#define AERIAL_PERSPECTIVE_SCALE 45.0
